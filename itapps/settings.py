...
print("AZURE_DB_NAME:", os.environ.get('AZURE_DB_NAME'))
print("AZURE_DB_HOST:", os.environ.get('AZURE_DB_HOST'))
print("AZURE_DB_PORT:", os.environ.get('AZURE_DB_PORT'))
print("AZURE_DB_USER:", os.environ.get('AZURE_DB_USER'))
